...
TEMPLATE_DIR = sys.path[0] + '\\templates\\'
...
def get_doc_display(doc):
    # https://bytes.com/topic/python/answers/21559-q-urlopen-file-c-mypage-html :/
    # also http://agiliq.com/blog/2013/03/serving-static-files-in-django/
    url = "file:///C|\\Users\\Zhu Feng\\Wormhole\\crawls\\focus8\\BasicBrowser\\static\\" + doc.title + ".html"
    url2 = "file:///C|\\Users\\Zhu Feng\\Wormhole\\crawls\\focus8\\BasicBrowser\\static\\" + doc.title.replace(" ", "_").replace("&amp;", '&')
